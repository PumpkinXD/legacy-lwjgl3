package io.github.pumpkinxd.legacylwjgl3.platform.windows.api.version;

import io.github.pumpkinxd.legacylwjgl3.platform.windows.api.Kernel32;
    ...
    public static @Nullable VersionInfo getModuleFileVersion(String filename) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            if (result == 0) {
                ...
                throw new RuntimeException("GetFileVersionInfoW failed, error=" + Kernel32.INSTANCE.GetLastError());
            }
