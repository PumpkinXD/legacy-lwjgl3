...
class D3DKMTAdapterInfoStruct extends Struct<D3DKMTAdapterInfoStruct> {
    ...
    public int sizeof() {
     ...
     static class Buffer extends StructBuffer<D3DKMTAdapterInfoStruct, Buffer> {
        ...
        //placeholders, just blame lwjgl 3.3.5
         @Override
         protected Buffer create(long address, @Nullable ByteBuffer container, int mark, int position, int limit, int capacity) {
             throw new UnsupportedOperationException("create() is not supported in this implementation");
         }

         public Buffer Slice() {
             throw new UnsupportedOperationException("Slice() is not supported in this implementation");
         }
         public Buffer Slice(int offset, int capacity) {
             throw new UnsupportedOperationException("Slice() is not supported in this implementation");
         }
         public Buffer duplicate(){
             throw new UnsupportedOperationException("duplicate() is not supported in this implementation");
         }
     }
}
