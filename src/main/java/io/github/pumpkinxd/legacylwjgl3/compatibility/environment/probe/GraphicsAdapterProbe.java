 ...
 * <a href="https://github.com/CaffeineMC/sodium/blob/3af8680fd14e4c8bd8f8f5eadf711ca20ce980cb/common/src/workarounds/java/net/caffeinemc/mods/sodium/client/compatibility/environment/probe/GraphicsAdapterProbe.java">...</a>
 */

public class GraphicsAdapterProbe {
    private static final Logger LOGGER = LogManager.getLogger("LegacyLwjgl3-GraphicsAdapterProbe");
    ...
    public static void findAdapters() {
        ...
        try {
            adapters = switch (Platform.get()) {
                case WINDOWS -> findAdapters$Windows();
